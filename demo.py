...
driver = mun_browser.open_random_driver(sock5='192.168.0.114:30000')
# Create an instace of webdriver
# service = Service("./msedgedriver.exe")
# driver = webdriver.Edge(service=service)

# Open target
driver.get('https://account.lenovo.com/us/en/account/login/?orgRef=https%253A%252F%252Fwww.google.com%252F')
