...
class Samclub:
    ...
    def login(self, email, password):
        self.driver.get('https://www.samsclub.com/')
        print('==login==')
        self.email = email
        self.password = password
        # self.go_login_page_by_google()
        # self.driver.get('https://www.samsclub.com/login?redirectURL=%2F')
        
        # email_present = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH ,"//input[@id='email']"))) 
        
        # password_present = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH ,"//input[@id='password']"))) 
        
        # signIn_present = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH ,'//*[@id="main"]/div/div[1]/div/div/div[1]/form/button'))) 
        
        # signInStay_present = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.CLASS_NAME ,"sc-header-account-button-icon")))
        ...
        # self.mun_browser.click_random_offset_element(signInStay_present)         
...
def main():
    ...
    ordervr = Samclub(mun_browser=mun_browser,driver=driver)
